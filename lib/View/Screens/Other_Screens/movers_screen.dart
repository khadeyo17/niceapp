...
class MoversScreen extends StatefulWidget {
  ...
  @override
  _MoversScreenState createState() => _MoversScreenState();
}
...
class _MoversScreenState extends State<MoversScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Movers Services'),
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Moving Details'),
              maxLines: 3,
            ),
            const SizedBox(height: 10),
            Expanded(
            ...
            ElevatedButton(
              ...
              child: const Text('Request Movers'),
            ),
          ],
        ),
      ),
