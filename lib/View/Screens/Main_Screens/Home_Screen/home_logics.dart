...
import 'package:niceapp/Container/Repositories/address_parser_repo.dart';
import 'package:niceapp/Container/Repositories/direction_polylines_repo.dart';
import 'package:niceapp/Container/Repositories/firestore_repo.dart';
import 'package:niceapp/Container/utils/error_notification.dart';
//import 'package:trippo_user/Container/utils/keys.dart';
import 'package:niceapp/Model/direction_model.dart';
      ...
      if (context.mounted) {
        ...
        Marker pickUpMarker = Marker(
          ...
          position: LatLng(
            ...
            ref.watch(homeScreenPickUpLocationProvider)!.locationLongitude!,
          ),
        );
        Marker dropOffMarker = Marker(
          ...
          position: LatLng(
            ...
            ref.watch(homeScreenDropOffLocationProvider)!.locationLongitude!,
          ),
        );
          ...
          builder: (context, ref, child) {
            return Container(
              ...
              child: AnimatedSwitcher(
                ...
                child:
                    ref.watch(homeScreenStartDriverSearch)
                        ? Column(
                          key: const Key("sec"),
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  double carType =
                                      ref
                                          ...
                                          : 1;
                                  String userFare =
                                      ref.read(homeScreenRateProvider) != null
                                          ? (((ref.read(
                            ...
                            InkWell(
                              onTap:
                                  ref.watch(homeScreenSelectedRideProvider) ==
                                      ...
                                      ? null
                                      : () {
                                        int seletectedDriver = int.parse(
                                          ref
                                              .read(
                                                homeScreenSelectedRideProvider,
                                              )
